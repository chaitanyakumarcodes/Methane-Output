...
model = pickle.load(open('C:\Machine Learning\JSPL Project\Methane\svr_model.pkl', 'rb'))
scaler = pickle.load(open('C:\Machine Learning\JSPL Project\Methane\scaler.pkl', 'rb'))
